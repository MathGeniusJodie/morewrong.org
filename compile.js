    ...
    files.forEach((file, index) => {
        ...
        <div class="article-container" id="${articleId}">
            ...
            <div class="article-meta">
                <span class="article-author"><span class="article-by">by</span> ${attributes.author}</span>
                <time class="article-time">${attributes.date=="NA"?"NA":new Intl.DateTimeFormat("en-US", { 
                    year: "numeric", 
                    month: "long", 
                    day: "numeric" 
                  }).format(new Date(attributes.date))}</time>
            </div>
            ${bodyHtml}
        ...
        <div class="post-item">
            ...
            <div class="post-content">
              <a href="#${articleId}" class="post-title"
                >${attributes.pin?`<span class="post-title-star">★</span> `:""}${attributes.title}</a
              >
              <div class="post-meta">
